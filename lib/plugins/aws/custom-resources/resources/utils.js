...
// Lazy-load aws-sdk so that the module can be required in test environments
// where aws-sdk is not needed (e.g. tests of getLambdaArn / getEnvironment).
let AWS;
const getAWS = () => {
  if (!AWS) {
